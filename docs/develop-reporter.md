...
| `EMULSIFY_SELF_CONTAINED_OUTPUT=0` | Opt into lean output for one build: repaired CSS points at project asset roots and Vite's project-asset copies are removed. The permanent switch is `assets.selfContainedOutput`.                                                    |
